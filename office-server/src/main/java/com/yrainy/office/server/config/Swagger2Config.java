package com.yrainy.office.server.config;
...
public class Swagger2Config {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                //指定哪个包下面生成接口文档
                .apis(RequestHandlerSelectors.basePackage("com.yrainy.office.server.controller"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                .title("云办公接口文档")
                .description("云办公接口文档")
                .contact(new Contact("yrainy", "localhost:8081/doc.html", "yrainy2021@163.com"))
                .build();
